...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6873144344').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002107579624').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://wasimsrk:acDHycKTnUTntbHf@cluster0.15nsttl.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'linkziper.com')
SHORTLINK_API = environ.get('SHORTLINK_API', 'db31f274fe5dd29137d93023d34b490183cbd788')
...
URL = f"https://demo-gsmz.onrender.com/{FQDN}" if ON_HEROKU or NO_PORT else f"https://demo-gsmz.onrender.com/{FQDN}:{PORT}"
...
if HAS_SSL:
    URL = f"https://demo-gsmz.onrender.com/{FQDN}"
else:
    URL = f"http://demo-gsmz.onrender.com/{FQDN}"
...
LOG_STR += ("Spell Check Mode Is Enabled, bot will be suggesting related movies if the movie is not found.\n" if SPELL_CHECK_REPLY else "SPELL_CHECK_REPLY Mode disabled.\n")

...
URL = "https://spare-kattie-wtechni.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://spare-kattie-wtechni.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://spare-kattie-wtechni.koyeb.app/".format(FQDN)
else:
    URL = "https://spare-kattie-wtechni.koyeb.app/".format(FQDN)
